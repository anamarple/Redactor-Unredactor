...
(function(){
    ...
    (function() {
    var p = "2451641", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_2451641||'',
    GUID:window.ftGUID_2451641||'99999999999',
    confID:window.ftConfID_2451641||'0',
    ftReturn: window.ftReturn_2451641||'',
    keyword:window.ftKeyword_2451641||'',
    ftId:window.ftId_2451641||'',
    imp:window.ftImp2451641,
    ftImpId:window.ftImp2451641 && window.ftImp2451641.impID || '',
    campaignID:'73682',
    cID:'74069',
    pID:'2451641',
    creativeID:'1780404',
    exttrack:["https://dishdigital.sp1.convertro.com/view/vt/v1/dishdigital/15/cvo.gif?cvosrc=Display.MediaMath.CRCKET&cvo_strategy=[FT_MMSTRATEGY]&cvo_dealid=[FT_MMDEALID]&cvo_site=[FT_MMDOMAIN]&cvo_versionid=[FT_CONFID]&cvo_pid=SLNGI_USA_CRCKET_DT_DIS_MT1_PPR_MEDIAMATHx_IPL17AB_CRCKET_728x090"],
    extscript:[""],
    clickTags: ["http://servedby.flashtalking.com/click/8/73682;2451641;1780404;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.sling.com/cricket?cvosrc=Display.MediaMath.CRCKET&cvo_strategy=[FT_MMSTRATEGY]&cvo_dealid=[FT_MMDEALID]&cvo_site=[FT_MMDOMAIN]&cvo_versionid=[FT_CONFID]&cvo_pid=SLNGI_USA_CRCKET_DT_DIS_MT1_PPR_MEDIAMATHx_IPL17AB_CRCKET_728x090&utm_source=rtbprospecting&utm_medium=display&utm_campaign=IPL17AB"],
    placementDescription:'SLNGIUSACRCKETDTDISMT1PPRMEDIAMATHxIPL17ABCRCKET728x090',
    width:728,
    height:90,
    ...
    divID:'ftdiv2451641',
    phID:'ftpos2451641',
    frameID:'ftframe2451641',
    expID:'ftexpframe2451641',
    altImgID:'ftalt2451641',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/73682;2451641;1780404;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.sling.com/cricket?cvosrc=Display.MediaMath.CRCKET&cvo_strategy=[FT_MMSTRATEGY]&cvo_dealid=[FT_MMDEALID]&cvo_site=[FT_MMDOMAIN]&cvo_versionid=[FT_CONFID]&cvo_pid=SLNGI_USA_CRCKET_DT_DIS_MT1_PPR_MEDIAMATHx_IPL17AB_CRCKET_728x090&utm_source=rtbprospecting&utm_medium=display&utm_campaign=IPL17AB',
    altImg:'http://servedby.flashtalking.com/imp/8/73682;2451641;204;gif;MediaMath;SLNGIUSACRCKETDTDISMT1PPRMEDIAMATHxIPL17ABCRCKET728x090/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/73682;2451641;271;pixel;MediaMath;SLNGIUSACRCKETDTDISMT1PPRMEDIAMATHxIPL17ABCRCKET728x090/?',
    iDeviceImp:'http://servedby.flashtalking.com/imp/8/73682;2451641;207;guid;MediaMath;SLNGIUSACRCKETDTDISMT1PPRMEDIAMATHxIPL17ABCRCKET728x090/?ft_guid=[%FT_GUID%]&cachebuster=[%CACHEBUSTER%]',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/245/2451641/1780404/js/j-2451641-1780404.js',
    file:'http://cdn.flashtalking.com/74069/1780404/main.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat8.flashtalking.com/reportV3/ft.stat?81507653-2451641;1780404;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:false,
    segment:window.ftSegment_2451641||'',
    segmentList:window.ftSegmentList_2451641||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp2451641 && window.ftImp2451641.jsAppend),
    ...
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m2451641')&&/^https:/.test(document.getElementById('ftscript_m2451641').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m2451641'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_2451641'],
        ['ftcfid', 'ftConfID_2451641'],
        ['fttime', 'ftTimestamp_2451641'],
        ['ftsection', 'ftSection_2451641'],
        ['ftcustom', 'ftCustom_2451641'],
        ['ft_id', 'ftId_2451641'],
        ['ftimpid','ftImp2451641', 'impID']
    ]
};
...
(function(o) {
  var mmReplace = function(s) {
    ...
    trackUrl = mmReplace("https://dishdigital.sp1.convertro.com/view/vt/v1/dishdigital/15/cvo.gif?cvosrc=Display.MediaMath.CRCKET&cvo_strategy=[FT_MMSTRATEGY]&cvo_dealid=[FT_MMDEALID]&cvo_site=[FT_MMDOMAIN]&cvo_versionid=[FT_CONFID]&cvo_pid=SLNGI_USA_CRCKET_DT_DIS_MT1_PPR_MEDIAMATHx_IPL17AB_CRCKET_728x090");
trackUrl = (o.secure) ? trackUrl.replace(/^http:/, "https:") : trackUrl;
new Image().src = o.replaceMacros(trackUrl);
if (!o.clicks){
(o.altimghref)?o.altimghref = mmReplace(String(o.altimghref)):o.altImgHref = mmReplace(String(o.altImgHref));
}
else{
