...
var d13="http://z1.zedo.com/asw";var q17=new function(){var p5=this;
p5.zd_has_flash=false;
...
var n12='application/x-shockwave-flash';var d10=navigator.mimeTypes;
if(d10&&d10[n12]&&d10[n12].enabledPlugin&&d10[n12].enabledPlugin.description){
p5.zd_has_flash=true;
}
...
var a6=navigator.userAgent.toLowerCase();var i28=(a6.indexOf('mac')!=-1);var y27=parseInt(navigator.appVersion);
var o29=(!i28&&(a6.indexOf('opera')==-1)&&(a6.indexOf('msie')!=-1)&&(y27>=4)&&(a6.indexOf('webtv')==-1
)&&(a6.indexOf('msie 4')==-1));
var v24=navigator.javaEnabled();var o6=1;var y37=document.createElement("audio");var y39=document.createElement("video");var q35={audio:(y37.play)?true:false,video:(y39.play)?true:false};
if(q35.audio&&q35.video){
o6 |=128;
}
if(v24){o6 |=4;}
if(q17.zd_has_flash){o6 |=8;}
if(o29){
...
var zd_networkID=0;var p0='';var e9=0;var zd_passback_publisherID;var zd_passback_networkID;var zd_passback_eventId;var zd_passback_adId;var zd_passback_channelId;
...
var zl_dm_params=zd_dm_params;var zl_dm_values=new Array();var n24=new RegExp(",","g");
...
if(zl_dm_values[i]!=""){
zl_dm_values[i]=zl_dm_values[i].replace(n24,"Z");
}}}
return zl_dm_values;
}
...
var zzState=0;}var zzSection=e9;var zzPbNId=zd_passback_networkID;var zzPbEId=zd_passback_eventId;var zzPbAId=zd_passback_adId;var zzPbCId=zd_passback_channelId;var zzPbGeoLvl=zd_passback_geoLevel;
var zzPbk=zd_Pbk;
...
var w31="";
try{
var v36=zd_get_domain(zd_detect_page_url(isJsTag));var e36=zd_get_top_parent_stack_url().split("?")[0];var p36=zd_get_domain(decodeURIComponent((zd_pg_url)));
w31=encodeURIComponent(v36+"_"+e36+"_"+p36+"_"+zd_get_stack_url_depth(e36)+"_"+zd_get_friendly_iframe_depth()+"_"+zd_pg_url);
}catch(t){}
return w31;
}
