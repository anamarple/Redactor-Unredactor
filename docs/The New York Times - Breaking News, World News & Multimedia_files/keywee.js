...
(function(){
	...
	var cat = null;
	var cat_element = document.querySelector('meta[name="dfp-ad-unit-path"]');	    
	if(cat_element){
	    cat = cat_element.getAttribute("content").split('/')[0];
	}
	return cat;
    }
    var getSection = function(){
	var section = null;
	var section_element = document.querySelector('meta[name="dfp-ad-unit-path"]');	    
	if(section_element){
	    section = section_element.getAttribute("content").split('/')[1];
	}
	return section;
    }    
    Keywee.init({
